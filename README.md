# Chris pépinières - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Chris pépinières**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@chrispepinieres.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@chrispepinieres.cm` | `user123` | |
...
*   **Contact :** contact@chrispepinieres.cm